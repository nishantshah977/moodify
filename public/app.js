...
function displayVideos(videos) {
  ...
  videos.forEach((video) => {
    ...
    videoElement.innerHTML = `
      ...
      <button id="play-${video.id}" class="bg-green-500 text-white p-2 mt-2 w-full"><div id="loader-${video.id}" class="hidden inline"> <svg width="20" height="20" fill="currentColor" class="mr-2 animate-spin inline" viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg">
